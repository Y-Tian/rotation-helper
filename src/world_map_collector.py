...
for index, world_map_id in enumerate(all_world_maps):
    ...
    world_map_details_endpoint = f"{world_map_conf.BASE_URL_ENDPOINT_BUILDER}/{world_map_id}"
    ...
    if base64_image_data:
        ...
        """
        generic_push_metadata(WORLD_MAPS_COLL, search_index_payload, mongo_metadata_payload_builder)
    else:
